-- CSP / Hyperscaler ResearchOS SQLite schema with scoring extensions
...
-- Scoring / quality extensions
CREATE TABLE IF NOT EXISTS module_scores (
  module_id TEXT PRIMARY KEY,
  coverage_score REAL NOT NULL,
  official_source_score REAL,
  recency_score REAL,
  confidence_score REAL,
  completeness_score REAL,
  evidence_count INTEGER,
  official_evidence_count INTEGER,
  fact_count INTEGER,
...
CREATE INDEX IF NOT EXISTS idx_evidence_source ON evidence_cards(source_id);
CREATE INDEX IF NOT EXISTS idx_facts_entity_metric ON facts(entity_id, metric);
CREATE INDEX IF NOT EXISTS idx_facts_module_metric ON facts(module_id, metric);
