...
const NAV_ITEMS = [
  { section: 'modules', label: '决策总览' },
  { section: 'entities', label: '公司观察' },
  { section: 'evidence', label: '证据库' },
  { section: 'followups', label: '待验证清单' },
  { section: 'claims', label: '观点校验' },
  { section: 'pricing', label: '价格/利用率' },
];
